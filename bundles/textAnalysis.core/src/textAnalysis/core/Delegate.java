...
/***
 * This class handles what happens when the runConfig is run.
 * It calls the Analysis and collects their output in the output file 
...
public class Delegate extends LaunchConfigurationDelegate {
	...
	@Override
    public void launch(ILaunchConfiguration configuration, String arg1, ILaunch arg2, 
     ...
     * 		   e.g. /example/directory/file.txt  -> /example/directory/file 
     */
